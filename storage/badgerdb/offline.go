...
func (b *Storage) InsertOfflineMessage(message xmpp.XElement, username string) error {
...
func (b *Storage) FetchOfflineMessages(username string) ([]xmpp.XElement, error) {
	var msgs []xmpp.Element
	...
	case 0:
		return nil, nil
	default:
		ret := make([]xmpp.XElement, len(msgs))
